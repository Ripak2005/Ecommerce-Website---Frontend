      ...
      {order && (
        <Container>
          <h3 className="text-center my-2 text-danger">
                            ...
                            <tr key={i}>
                                ...
                                <td>
                                    <Link to={`/product/${e.product._id}`}>
                                        <img src={`${server}/${e.product.image}`} width={60}/>
                                    </Link>
                                </td>
                                <td>{e.quantity}</td>
            ...
            <h5 className="text-center my-2 text-primary">Subtotal - ₹ {order.subTotal}</h5>
            ...
            {order.paymentInfo && <h5 className="text-center my-2 text-primary">paymentId - {order.paymentInfo}</h5>}
            <p className="text-center"><Button onClick={() => navigate('/order')}>Go Back</Button></p>
        </Container>
      )}
    </>
  );
